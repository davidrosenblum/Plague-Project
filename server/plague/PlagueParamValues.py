...
class PlagueParamValues:
    ...
    def validate_infection_length(infection_length):
        ...
        min_val = PlagueParamValues.INFECTION_LENGTH[0]
        max_val = PlagueParamValues.INFECTION_LENGTH[1]
    ...
    def validate_transmission_rate(transmission_rate):
        ...
        min_val = PlagueParamValues.TRANSMISSION_RATE[0]
        max_val = PlagueParamValues.TRANSMISSION_RATE[1]

        if transmission_rate < min_val or transmission_rate > max_val:
            raise ValueError("Transmission value must be in the range {a}-{b}.".format(a=min_val, b=max_val))
    ...
    def validate_virulence(virulence):
        ...
        min_val = PlagueParamValues.VIRULENCE[0]
        max_val = PlagueParamValues.VIRULENCE[1]
    ...
    def validate_initial_population(initial_population):
        ...
        min_val = PlagueParamValues.INITIAL_POPULATION[0]
        max_val = PlagueParamValues.INITIAL_POPULATION[1]
    ...
    def validate_immune_percent(immune_percent):
        ...
        min_val = PlagueParamValues.IMMUNE_PERCENT[0]
        max_val = PlagueParamValues.IMMUNE_PERCENT[1]
    ...
    def validate_initial_infected(initial_infected, initial_population=None):
        ...
        min_val = PlagueParamValues.INITIAL_INFECTED[0]
        max_val = initial_population or PlagueParamValues.INITIAL_INFECTED[1]
    ...
    def validate_simulation_length(simulation_length):
        ...
        min_val = PlagueParamValues.SIMULATION_LENGTH[0]
        max_val = PlagueParamValues.SIMULATION_LENGTH[1]
    ...
    def validate_all_params(params_dict):
        ...
        if "infection_length" in params_dict:
            ...
            PlagueParamValues.validate_infection_length(infection_length) 
        else:
        ...
        if "transmission_rate" in params_dict:
            ...
            PlagueParamValues.validate_transmission_rate(transmission_rate) 
        else:
            raise ValueError("Transmission parameter missing.")


        # virulence check
        if "virulence" in params_dict:
            virulence = params_dict["virulence"]
            PlagueParamValues.validate_virulence(virulence) 
        else:
        ...
        if "initial_population" in params_dict:
            ...
            PlagueParamValues.validate_initial_population(initial_population) 
        else:
        ...
        if "immune_percent" in params_dict:
            ...
            PlagueParamValues.validate_immune_percent(immune_percent) 
        else:
        ...
        if "initial_infected" in params_dict:
            ...
            PlagueParamValues.validate_initial_infected(initial_infected, initial_population) 
        else:
        ...
        if "simulation_length" in params_dict:
            ...
            PlagueParamValues.validate_simulation_length(simulation_length)
        else:
