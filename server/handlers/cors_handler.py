...
class CORSHandler(tornado.web.RequestHandler):
    ...
    def set_default_headers(self):
        ...
        self.set_header("Access-Control-Allow-Headers", "Access-Control-Allow-Origin, Content-Type, First-Invalid-Day")
        self.set_header("Access-Control-Expose-Headers", "First-Invalid-Day")
